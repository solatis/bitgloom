...
, bitgloom-btc, bitgloom-driver, bitgloom-tor, bitgloom-worker
...
mkDerivation {
  ...
  buildDepends = [
    ...
    bitgloom-driver bitgloom-tor bitgloom-worker bytestring
    classy-prelude classy-prelude-conduit classy-prelude-yesod conduit
    containers data-default directory fast-logger file-embed hjsmin
    http-conduit monad-control monad-logger mtl persistent
    persistent-sqlite persistent-template safe shakespeare
    template-haskell text time unordered-containers vector wai-extra
    wai-logger warp yaml yesod yesod-core yesod-form yesod-persistent
    yesod-static
  ];
